Perfetto! Automatizzare la generazione delle chiavi e il processo di build con uno script è un'ottima mossa per rendere la gestione della CTF ancora più fluida e ripetibile.
